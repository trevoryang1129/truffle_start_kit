...
(() => (0, tslib_1.__awaiter)(void 0, void 0, void 0, function* () {
    ...
    if (program.sharedFolder && (0, fs_extra_1.existsSync)((0, utils_1.absolutePath)('./', program.sharedFolder))) {
        ...
        try {
            ...
            const hardhatConfigFilePath = (0, utils_1.absolutePath)('./', program.sharedFolder) + '/hardhat.config.js';
            const isHardhatProject = (0, fs_extra_1.existsSync)(hardhatConfigFilePath);
            if (isHardhatProject) {
